 ...
 *
 * این ضریب با متن ثانویه گره خورده: muted روی کارت بژ ۵٫۰:۱ است و ابرِ
 * پشتش آن را می‌خورد. با ۰٫۳۰ به ۴٫۷۶:۱ می‌رسد که هنوز بالای استاندارد است.
 * ضریب بالاتر (نسخهٔ قبلی ۰٫۴۵ بود) متن را زیر ۴٫۵ می‌برد — اندازه‌گیری شده
 * روی نودونه گرهٔ متنی، نه فرضی.
 *
 * اگر روزی رنگ متن روشن‌تر شد، این عدد هم باید پایین بیاید.
 */
