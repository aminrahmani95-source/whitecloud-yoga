...
export const metadata: Metadata = {
  title: "فروشگاه",
  description:
    "لوازم تمرین یوگا در باشگاه بانوان ابر سفید، کرج — مت، بلوک، کش مقاومتی و قمقمه. پرداخت آنلاین نداریم؛ سفارش تلفنی یا در دایرکت اینستاگرام ثبت می‌شود.",
};
      ...
      <main className="flex-1">
        <Section id="products">
          <SectionHeading
            eyebrow="فروشگاه"
            title="لوازم تمرین"
            lead="چند قلم ساده و بادوام — همان‌هایی که در کلاس‌ها هم استفاده می‌کنیم. برای سفارش تماس بگیرید یا در دایرکت پیام بدهید."
          />
          ...
          <p className="mt-10 max-w-xl text-sm leading-loose text-muted">
            پرداخت آنلاین هنوز فعال نیست. سفارش را تلفنی یا در دایرکت ثبت
            می‌کنیم و کالا را در خود استودیو تحویل می‌گیرید.
          </p>
        </Section>
      </main>
