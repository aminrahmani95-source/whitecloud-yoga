...
export const metadata: Metadata = {
  title: "مربیان",
  description:
    "چهار مربی استودیو ابر سفید — از تمرین‌های آرام یین و رستوراتیو تا کلاس‌های پرانرژی آشتانگا و هوت یوگا. پروفایل کامل هر مربی را ببینید.",
};
...
export default function TeachersPage() {
  return (
    <PageShell
      ...
      lead="چهار مربی با سبک‌های متفاوت — از تمرین‌های آرام و کشدار تا کلاس‌های پرانرژی. روی هر کارت بزنید تا پروفایل کامل او را ببینید."
    >
      <Section id="teachers">
